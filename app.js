...
function createItemCard(item) {
    ...
    card.innerHTML = `
        ${item.image_url ? `<img src="${item.image_url}" alt="${item.title}" class="item-image" onerror="this.style.display='none'">` : ''}
...
async function showItemDetails(item) {
    ...
    content.innerHTML = `
        ${item.image_url ? `<img src="${item.image_url}" alt="${item.title}" class="modal-item-image">` : ''}
